package ru.mtsbank.cardoffice.cardissuance;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;

/**
 * Boot entry point for card-issuance-service.
 *
...
public class CardIssuanceServiceApplication {

    public static void main(String[] args) {
        SpringApplication.run(CardIssuanceServiceApplication.class, args);
    }
}
