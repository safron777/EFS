package ru.mtsbank.cardoffice.incidentcase;

import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;

/**
 * Boot entry point for incident-case-service.
 *
...
public class IncidentCaseServiceApplication {

    public static void main(String[] args) {
        SpringApplication.run(IncidentCaseServiceApplication.class, args);
    }
}
